...
$_truefalseundef = @('true', 'false', 'undefined')
$_yesno = @('yes', 'no')
...
_new_tag __GLOBAL_ATTR__ -Params @(
	...
	@('AriaBusy', 'String', $_truefalse),
	@('AriaChecked', 'String', @('true', 'false', 'mixed', 'undefined')),
	@('AriaColCount', 'String'),
	@('AriaColIndex', 'String'),
	@('AriaColIndexText', 'String'),
	@('AriaColSpan', 'String'),
	@('AriaControls', 'String'),
	@('AriaCurrent', 'String', @('page', 'step', 'location', 'date', 'time',
		'true', 'false')),
	@('AriaDescribedBy', 'String'),
	@('AriaDescription', 'String'),
	@('AriaDetails', 'String'),
	@('AriaDisabled', 'String', $_truefalse),
	@('AriaDropEffect', 'String', @('copy', 'execute', 'link', 'move', 'none',
		'popup')),
	@('AriaErrorMessage', 'String'),
	@('AriaExpanded', 'String', $_truefalseundef),
	@('AriaFlowTo', 'String'),
	@('AriaGrabbed', 'String', $_truefalseundef),
	@('AriaHasPopup', 'String', @('true', 'false', 'menu', 'listbox', 'tree',
		'grid', 'dialog')),
	@('AriaHidden', 'String', $_truefalseundef),
	@('AriaInvalid', 'String', @('true', 'false', 'grammar', 'spelling')),
	@('AriaKeyboardShortcuts', 'String'),
	@('AriaLabel', 'String'),
	@('AriaLabelledBy', 'String'),
	@('AriaLevel', 'String'),
	@('AriaLive', 'String', @('assertive', 'off', 'polite')),
	@('AriaModal', 'String', $_truefalse),
	@('AriaMultiline', 'String', $_truefalse),
	@('AriaMultiSelectable', 'String', $_truefalse),
	@('AriaOrientation', 'String', @('horizontal', 'vertical', 'undefined')),
	@('AriaOwns', 'String'),
	@('AriaPlaceholder', 'String'),
	@('AriaPosInset', 'String'),
	@('AriaPressed', 'String', @('true', 'false', 'mixed', 'undefined')),
	@('AriaReadOnly', 'String', $_truefalse),
	@('AriaRelevant', 'String', @('additions', 'all', 'removals', 'text')),
	...
	@('AriaSetSize', 'String'),
	@('AriaSort', 'String', @('ascending', 'descending', 'none', 'other')),
	@('AriaValueMax', 'String'),
	@('AriaValueMin', 'String'),
	@('AriaValueNow', 'String'),
